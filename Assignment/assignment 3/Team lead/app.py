...
COS_API_KEY_ID="F0Rcix_YBmxRlygaKIge1v-iTKcK7Z8jcP_cE3Sg_iLO" 
COS_INSTANCE_CRN="crn:v1:bluemix:public:cloud-object-storage:global:a/efd5ddf687b5430588290b5d15cb0033:f25015df-d0e6-40e3-af80-fbf617164f48::"
...
@app.route('/')
def index():
    files = get_bucket_contents('swetharockz')
